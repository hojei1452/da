...
#include "ui_devselectdlg.h"

DevSelectDlg::DevSelectDlg(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DevSelectDlg)
{
    ui->setupUi(this);
...
void DevSelectDlg::on_buttonBox_clicked(QAbstractButton *button)
{
